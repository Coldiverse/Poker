	...
	public void tick() {
		...
		if(scoreKeep >= (300)) {
			...
			if(hud.getLevel() == 1) {
				...
				handler.addObject(new FastEnemyV(r.nextInt(Game.WIDTH - 50), r.nextInt(Game.HEIGHT - 50), ID.FastEnemyV, handler));
			}else if(hud.getLevel() == 5) {
				handler.addObject(new FastEnemyH(r.nextInt(Game.WIDTH - 50), r.nextInt(Game.HEIGHT - 50), ID.FastEnemyH, handler));
